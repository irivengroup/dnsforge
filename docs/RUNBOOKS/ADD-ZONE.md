...
```bash
vi src/build/dns-authoritative/zones/external/master/example.net.conf
vi src/build/dns-authoritative/zones/external/master/example.net.zone
...
```bash
vi src/build/dns-proxy/zones/external/secondary/example.net.conf
