...
def test_zone_record_lifecycle(tmp_path: Path) -> None:
    ...
    manager.add_record("example.com", "A:www:192.168.10.10", ttl=300)
    assert "www 300 IN A 192.168.10.10" in manager.show("example.com")
    manager.update_record("example.com", "A:www:192.168.10.10:192.168.10.15", ttl=300)
    assert "192.168.10.15" in manager.show("example.com")
    manager.delete_record("example.com", "A:www")
