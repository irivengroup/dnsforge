...
def create_fastapi_app(core: ManagerApplication | None = None) -> Any:
    ...
    @app.get("/dnssync/history")
    def dnssync_history(cluster_id: str | None = None) -> dict[str, Any]:
        return manager.dnssync_history(cluster_id)
