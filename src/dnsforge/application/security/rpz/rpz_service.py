...
class RpzService:
    ...
    def enable(self, setup_file: Path) -> str: return f'RPZ enable planned for {setup_file}'
    def update(self) -> str: return 'RPZ update planned'
    def test(self, domain: str) -> str: return f'RPZ test planned: {domain}'
